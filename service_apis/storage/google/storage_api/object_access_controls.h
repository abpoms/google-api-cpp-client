...
class ObjectAccessControls : public client::JsonCppData {
 public:
   ...
   */
  const client::JsonCppArray<client::JsonCppData > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<client::JsonCppData > >(storage);
  }
   ...
   */
  client::JsonCppArray<client::JsonCppData > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<client::JsonCppData > >(storage);
  }
